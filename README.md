...
!UPDATE: We have released all datasets used for pre-training. These datasets can be further explored, searched, and downloaded from our dedicated data portal at: \url{https://sctp4m.aigenomicsyulab.com).
